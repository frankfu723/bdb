  ...
  return (
    ...
    <nav className="hidden sm:flex flex-1 justify-end font-serif font-semibold">
      <ul className="flex items-center text-[13px] sm:text-sm md:text-[15px] lg:text-base text-green-900 divide-x divide-green-700">
        ...
        <li className="relative px-2 sm:px-2.5 md:px-3 lg:px-5 group whitespace-nowrap">
          ...
          >
            <div className="py-1">
              ...
              <Link href="/products/oxy-series/human/soft" className="block px-4 py-2 text-gray-700 hover:bg-gray-50" role="menuitem">
                人用微壓氧艙
              </Link>
              <Link href="/products/oxy-series/human/premium" className="block px-4 py-2 text-gray-700 hover:bg-gray-50" role="menuitem">
                豪華高壓氧艙
              </Link>
        ...
        <li className="px-2 sm:px-2.5 md:px-3 lg:px-5 whitespace-nowrap">
          <a href="https://lin.ee/99Ad6LH" target="_blank" rel="noopener noreferrer">聯絡我們</a>
        </li>
      </ul>
    </nav>
  );
